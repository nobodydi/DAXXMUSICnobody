...
bg_path = "AnonX/assets/userinfo.png"
font_path = "AnonX/assets/hiroko.ttf"
...
￼Enter@Hiroko.on_message(filters.command(["info", "userinfo"]))
async def userinfo(_, message):
    chat_id = message.chat.id
    user_id = message.from_user.id
...
async def userinfo(_, message):
    ...
    if not message.reply_to_message and len(message.command) == 2:
        ...
        try:
            ...
            await message.reply_text(str(e))
er@Hiroko.on_message(filters.command(["info", "userinfo"]))
async def userinfo(_, message):
    chat_id = message.chat.id
    user_id = message.from_user.id
    ...
    if not message.reply_to_message and len(message.command) == 2:
      ...
      await Hiroko.send_photo(chat_id, photo=welcome_photo, caption=INFO_TEXT.format(
            ...
            await message.reply_text(str(e))￼Enter            await message.reply_text(str(e))
